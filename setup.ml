(* OASIS_START *)
(* DO NOT EDIT (digest: 0dcd27b63399d36413e2c96af0e3740d) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/pa_structural_sexp";
          synopsis =
          ...
          sections =
            [
               Library
                 ({
                     cs_name = "pa_structural_sexp_lib";
                   ...
                   {
                      lib_modules = ["Pa_structural_sexp_dummy"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "pa_structural_sexp";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "pa_structural_sexp";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Pa_structural_sexp"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "pa_structural_sexp_lib";
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\218\028\191\186\229P\153\162\240h\171\184.\029\228\132";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
